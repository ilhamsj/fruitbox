...
import logoMini from '../Template/images/logo-mini.svg';
import face4 from '../Template/images/faces/face4.jpg';
...
const Header = () => {
    ...
    return (
        <nav className="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
                ...
                <div className="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="messageDropdown">
                    ...
                    <a className="dropdown-item" href="/">
                        <div className="item-thumbnail">
                            <img src={face4} alt="face" className="profile-pic"/>
                        </div>
                    ...
                    <a className="dropdown-item" href="/">
                        <div className="item-thumbnail">
                            <img src={face2} alt="face2" className="profile-pic"/>
                        </div>
                        <div className="item-content flex-grow">
                    ...
                    <a className="dropdown-item" href="/">
                        <div className="item-thumbnail">
                            <img src={face3} alt="face3" className="profile-pic"/>
                        </div>
                        <div className="item-content flex-grow">
            ...
            <button className="navbar-toggler navbar-toggler-right d-lg-none align-self-center" type="button" data-toggle="offcanvas" onClick={toggleSidebarMobile}>
